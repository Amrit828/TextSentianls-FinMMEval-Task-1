...
QUESTIONS_PATH = Path(r"C:\Users\amrit\Documents\ResearchLab\CLEF\chinese_task1_final_public.jsonl")
TEMPLATE_PATH = Path(r"C:\Users\amrit\Documents\ResearchLab\CLEF\chinese_task1_final_submission_template.json")
OUTPUT_PATH = Path(r"C:\Users\amrit\Documents\ResearchLab\CLEF\chinese_task1_final_submission_groq_v3.json")
...
def build_query_example(row: dict) -> base.MCQExample:
    return base.MCQExample(
        row_id=row["id"],
        dataset_id="chinese_task1_final_public",
        split="public",
        language="Chinese",
...
def main():
    ...
    print(f"Loaded {len(questions)} Chinese public/dev questions")
